...
(function () {
    ...
    */
    ...
    /*
        ...
        // Parámetros:
        //---------------------------------
        // @response:   Respuesta que retorna el en .data de HTML que retorna la función get.  {object}
        // @args:       Propiedades externas a la estructura window.REQUESTOBJECT.  {object}
        //---------------------------------
    */
    function fnBind(response, args) {
        var element = document.querySelector(args.query);
        element.innerHTML = response.data.replace(/\r\n/, "\r").replace(/\t/g, '    ');
    } // end function
    //---------------------------------
