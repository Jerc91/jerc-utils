...
(function () {
    ...
    /*
        ...
        // Ejemplo: var myApp = new Assembly();
    ...
    */
    function fnGetFile(data, fnCall) {
        ...
        */
        ...
        /*
            ...
            // webworkers esta información sea tratada
            //---------------------------------
            // Parámetros:
            //---------------------------------
            ...
            // @worker.data.action:         'Read' (deprecated)
            // @worker.data.update:         Esto por si se actualizo el archivo o solo se leyó del explorador
    ...
    /*
        ...
        //                 en el documento
        // @d.isNew:       Valor para saber si se salta la validación de si existe el 
